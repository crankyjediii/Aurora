      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 relative z-10 bg-charcoal-950">
        <div className="w-full max-w-sm flex flex-col gap-6">
          ...
          <form className="flex flex-col gap-4 mt-6">
            ...
            <Button type="button" className="w-full h-12 rounded-xl mt-4 shadow-[0_0_20px_rgba(139,92,246,0.2)]">
              Log In
            </Button>
          </form>

          <p className="text-xs text-graphite-500 text-center mt-4 cursor-pointer hover:text-graphite-400 transition-colors">
          ...
          <Button type="button" variant="outline" className="w-full h-12 text-white font-medium rounded-xl transition-all flex items-center justify-center gap-3 bg-graphite-900 hover:bg-graphite-800 border-graphite-800">
